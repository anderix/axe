...
`axe.css` may only reference variables defined in this list. Adding a new variable to `axe.css` requires adding it to `brand.css` and the brand builder output.
